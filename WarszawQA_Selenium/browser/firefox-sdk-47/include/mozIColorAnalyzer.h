...
#define NS_DECL_MOZIREPRESENTATIVECOLORCALLBACK \
  NS_IMETHOD OnComplete(bool success, uint32_t color) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_MOZIREPRESENTATIVECOLORCALLBACK \
  NS_METHOD OnComplete(bool success, uint32_t color); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_MOZIREPRESENTATIVECOLORCALLBACK(_to) \
  NS_IMETHOD OnComplete(bool success, uint32_t color) override { return _to OnComplete(success, color); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_MOZIREPRESENTATIVECOLORCALLBACK(_to) \
  NS_IMETHOD OnComplete(bool success, uint32_t color) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnComplete(success, color); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(_MYCLASS_, mozIRepresentativeColorCallback)
...
#define NS_DECL_MOZICOLORANALYZER \
  NS_IMETHOD FindRepresentativeColor(nsIURI *imageURI, mozIRepresentativeColorCallback *callback) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_MOZICOLORANALYZER \
  NS_METHOD FindRepresentativeColor(nsIURI *imageURI, mozIRepresentativeColorCallback *callback); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_MOZICOLORANALYZER(_to) \
  NS_IMETHOD FindRepresentativeColor(nsIURI *imageURI, mozIRepresentativeColorCallback *callback) override { return _to FindRepresentativeColor(imageURI, callback); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_MOZICOLORANALYZER(_to) \
  NS_IMETHOD FindRepresentativeColor(nsIURI *imageURI, mozIRepresentativeColorCallback *callback) override { return !_to ? NS_ERROR_NULL_POINTER : _to->FindRepresentativeColor(imageURI, callback); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(_MYCLASS_, mozIColorAnalyzer)
