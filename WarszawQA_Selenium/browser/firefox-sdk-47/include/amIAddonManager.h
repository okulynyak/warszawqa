...
#define NS_DECL_AMIADDONMANAGER \
  NS_IMETHOD MapURIToAddonID(nsIURI *aURI, nsACString & aID, bool *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_AMIADDONMANAGER \
  NS_METHOD MapURIToAddonID(nsIURI *aURI, nsACString & aID, bool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_AMIADDONMANAGER(_to) \
  NS_IMETHOD MapURIToAddonID(nsIURI *aURI, nsACString & aID, bool *_retval) override { return _to MapURIToAddonID(aURI, aID, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_AMIADDONMANAGER(_to) \
  NS_IMETHOD MapURIToAddonID(nsIURI *aURI, nsACString & aID, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->MapURIToAddonID(aURI, aID, _retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(amAddonManager, amIAddonManager)
