...
#define NS_DECL_IMGIONLOADBLOCKER \
  NS_IMETHOD BlockOnload(imgIRequest *aRequest) override; \
  NS_IMETHOD UnblockOnload(imgIRequest *aRequest) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_IMGIONLOADBLOCKER \
  NS_METHOD BlockOnload(imgIRequest *aRequest); \
  NS_METHOD UnblockOnload(imgIRequest *aRequest); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_IMGIONLOADBLOCKER(_to) \
  NS_IMETHOD BlockOnload(imgIRequest *aRequest) override { return _to BlockOnload(aRequest); } \
  NS_IMETHOD UnblockOnload(imgIRequest *aRequest) override { return _to UnblockOnload(aRequest); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_IMGIONLOADBLOCKER(_to) \
  NS_IMETHOD BlockOnload(imgIRequest *aRequest) override { return !_to ? NS_ERROR_NULL_POINTER : _to->BlockOnload(aRequest); } \
  NS_IMETHOD UnblockOnload(imgIRequest *aRequest) override { return !_to ? NS_ERROR_NULL_POINTER : _to->UnblockOnload(aRequest); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(_MYCLASS_, imgIOnloadBlocker)
