...
#ifndef mozilla_dom_DownloadEvent_h
#define mozilla_dom_DownloadEvent_h
...
protected:
  ...
  explicit DownloadEvent(mozilla::dom::EventTarget* aOwner);

  RefPtr<DOMDownload> mDownload;

public:
  virtual DownloadEvent* AsDownloadEvent() override;
...
#endif // mozilla_dom_DownloadEvent_h
