...
#ifndef mozilla_dom_ClipboardEventBinding_h
#define mozilla_dom_ClipboardEventBinding_h
...
struct ClipboardEventInit : public EventInit
{
  ...
  explicit inline ClipboardEventInit(const FastDictionaryInitializer& )
...
struct FastClipboardEventInit : public ClipboardEventInit
{
  inline FastClipboardEventInit()
    : ClipboardEventInit(FastDictionaryInitializer())
  {
...
#endif // mozilla_dom_ClipboardEventBinding_h
