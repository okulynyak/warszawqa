...
#ifndef mozilla_dom_DOMErrorBinding_h
#define mozilla_dom_DOMErrorBinding_h
...
namespace DOMErrorBinding {

  typedef mozilla::dom::DOMError NativeType;
...
#endif // mozilla_dom_DOMErrorBinding_h
