...
#ifndef mozilla_dom_DataErrorEvent_h
#define mozilla_dom_DataErrorEvent_h
...
protected:
  ...
  explicit DataErrorEvent(mozilla::dom::EventTarget* aOwner);

  nsString mMessage;

public:
  virtual DataErrorEvent* AsDataErrorEvent() override;
...
#endif // mozilla_dom_DataErrorEvent_h
