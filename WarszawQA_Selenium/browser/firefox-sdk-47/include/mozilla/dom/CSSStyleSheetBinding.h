...
enum class CSSStyleSheetParsingMode : uint32_t {
  Author,
  User,
  Agent,
  EndGuard_
...
namespace CSSStyleSheetBinding {
  ...
  typedef mozilla::CSSStyleSheet NativeType;
  ...
  bool
  Wrap(JSContext* aCx, mozilla::CSSStyleSheet* aObject, nsWrapperCache* aCache, JS::Handle<JSObject*> aGivenProto, JS::MutableHandle<JSObject*> aReflector);
