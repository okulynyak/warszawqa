...
#ifndef mozilla_dom_CSSPseudoElementBinding_h
#define mozilla_dom_CSSPseudoElementBinding_h
...
namespace CSSPseudoElementBinding {

  typedef mozilla::dom::CSSPseudoElement NativeType;
...
#endif // mozilla_dom_CSSPseudoElementBinding_h
