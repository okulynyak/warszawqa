...
#ifndef mozilla_dom_DOMRectListBinding_h
#define mozilla_dom_DOMRectListBinding_h
...
namespace DOMRectListBinding {

  typedef mozilla::dom::DOMRectList NativeType;
...
#endif // mozilla_dom_DOMRectListBinding_h
