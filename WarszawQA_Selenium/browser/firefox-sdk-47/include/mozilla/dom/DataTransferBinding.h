...
#ifndef mozilla_dom_DataTransferBinding_h
#define mozilla_dom_DataTransferBinding_h
...
namespace DataTransferBinding {

  typedef mozilla::dom::DataTransfer NativeType;
...
#endif // mozilla_dom_DataTransferBinding_h
