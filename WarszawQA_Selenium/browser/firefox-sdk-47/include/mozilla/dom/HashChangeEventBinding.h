...
#ifndef mozilla_dom_HashChangeEventBinding_h
#define mozilla_dom_HashChangeEventBinding_h
...
struct HashChangeEventInit : public EventInit
{
  ...
  explicit inline HashChangeEventInit(const FastDictionaryInitializer& )
...
struct FastHashChangeEventInit : public HashChangeEventInit
{
  inline FastHashChangeEventInit()
    : HashChangeEventInit(FastDictionaryInitializer())
  {
...
#endif // mozilla_dom_HashChangeEventBinding_h
