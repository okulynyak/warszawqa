...
#ifndef mozilla_dom_BoxObjectBinding_h
#define mozilla_dom_BoxObjectBinding_h
...
namespace BoxObjectBinding {

  typedef mozilla::dom::BoxObject NativeType;
...
#endif // mozilla_dom_BoxObjectBinding_h
