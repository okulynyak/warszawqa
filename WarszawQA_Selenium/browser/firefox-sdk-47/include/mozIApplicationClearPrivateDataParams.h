...
#define NS_DECL_MOZIAPPLICATIONCLEARPRIVATEDATAPARAMS \
  ...
  NS_IMETHOD GetBrowserOnly(bool *aBrowserOnly) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_MOZIAPPLICATIONCLEARPRIVATEDATAPARAMS \
  NS_METHOD GetAppId(uint32_t *aAppId); \
  NS_METHOD GetBrowserOnly(bool *aBrowserOnly); 
...
#define NS_FORWARD_MOZIAPPLICATIONCLEARPRIVATEDATAPARAMS(_to) \
  ...
  NS_IMETHOD GetBrowserOnly(bool *aBrowserOnly) override { return _to GetBrowserOnly(aBrowserOnly); } 
...
#define NS_FORWARD_SAFE_MOZIAPPLICATIONCLEARPRIVATEDATAPARAMS(_to) \
  ...
  NS_IMETHOD GetBrowserOnly(bool *aBrowserOnly) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBrowserOnly(aBrowserOnly); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(_MYCLASS_, mozIApplicationClearPrivateDataParams)
