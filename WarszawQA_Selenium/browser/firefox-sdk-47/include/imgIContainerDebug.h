...
#define NS_DECL_IMGICONTAINERDEBUG \
  NS_IMETHOD GetFramesNotified(uint32_t *aFramesNotified) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_IMGICONTAINERDEBUG \
  NS_METHOD GetFramesNotified(uint32_t *aFramesNotified); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_IMGICONTAINERDEBUG(_to) \
  NS_IMETHOD GetFramesNotified(uint32_t *aFramesNotified) override { return _to GetFramesNotified(aFramesNotified); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_IMGICONTAINERDEBUG(_to) \
  NS_IMETHOD GetFramesNotified(uint32_t *aFramesNotified) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFramesNotified(aFramesNotified); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(_MYCLASS_, imgIContainerDebug)
